...
const AddProjectPage = ({ addProjectSubmit }: { addProjectSubmit: (project: any) => void }) => {
	...
	const submitForm = (e: React.SubmitEvent<HTMLFormElement>) => {
		...
		toast.success("Project added successfully!"); // Show success toast on successful submission
		return navigate("/projects"); // Redirect to the projects page after submission
	};
